...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  const routesToHideNavbarAndFooter = ['/login', '/crearCuenta', '/admin', '/userAdmin', '/editarLibro/[id]', '/nuevoLibro', '/admin/RecuperarLibro','/editarUsuario/[id]', '/admin/RecuperarUsuario'];
